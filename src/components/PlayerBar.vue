...
const {
    currentTrack, isPlaying, progressPercent, formattedProgress,
    formattedDuration, volume, toggle, next, prev, seekTo, setVolume
} = usePlayer();
...
<template>
    <footer class="footer-bar" v-if="currentTrack">
        <div class="now-playing">
            <Vinyl :color="currentTrack.color" :is-playing="isPlaying" :size="52" />
        ...
        <div class="transport">
            <div class="transport-buttons">
                <button class="ctrl-btn" @click="prev" aria-label="Previously track">
                    ⏮
                </button>
                ...
                <button class="ctrl-btn" @click="next" aria-label="Next track">
                    ⏭
                </button>
            </div>
